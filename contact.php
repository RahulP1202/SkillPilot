...
<?php include 'header.php'?>
		...
		<div class="hero-area section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/zac1.jpg); " ></div>
			<!-- /Backgound Image -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						...
						<ul class="contact-details">
							<li><i class="fa fa-envelope"></i>SkillPilot@gmail.com</li>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="footer-logo">
							<a class="logo" style="font-size: 30px;" href="main.html">SkillPilot</a>
						</div>
					</div>
					<!-- footer logo -->
